                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="relative" ref={dropdownRef}>
                            <div onClick={toggleDropdown} className="flex items-center space-x-3 cursor-pointer">
                                ...
                                <span className="text-white text-sm font-medium">{userProfile.username || 'User'}</span>
                                {/* Chevron Arrow */}
                                <svg
                            ...
                            {isDropdownOpen && (
                                ...
                                >
                                    <ul className="py-2">
                                        ...
                                        <li className="px-4 py-2 hover:bg-red-50 cursor-pointer transition-colors duration-150 text-red-600">Logout</li>
                                    </ul>
                                </div>
                            )}
                        </div>
