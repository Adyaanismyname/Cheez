...
const TopBar = ({ userProfile = {}, searchQuery = '', onSearchChange = () => { }, onSearchSubmit = () => { }, onSearchReset = () => { } }) => {
                    ...
                    <div className="flex-1 max-w-2xl mx-8">
                        <div className="relative">
                            <input
                                ...
                                className="bg-white w-full px-4 py-2 pl-10 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent transition duration-200 outline-none"
